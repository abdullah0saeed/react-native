    ...
    <View style={styles.container}>
      ...
      <View style={styles.numbers}>
        ...
        <TextInput style={{
             ...
             width: 50,
             textAlign: 'center',
             backgroundColor: !selectedSymbol? "#3454d1" : isCorrect ? 'green' : 'red',
             color: 'white',
             width:116,
             height: 129

        }} value={selectedSymbol} editable={false} />
        <TextInput style={styles.input} value={number2.toString()} editable={false} />
      </View>
      <View style={styles.buttons}>
        {mathSymbols.map((symbol) => (
          ...
          <Button key={symbol} title={symbol} onPress={() => selectSymbol(symbol)} />
          </View>
        ))}
      </View>
      {selectedSymbol !== '' && (
